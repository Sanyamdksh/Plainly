...
const AccessDenied = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center -translate-y-14 ">
      ...
      <button
        className="p-3 bg-amber-300 mt-7 rounded-xl text-black font-semibold cursor-pointer transition-transform duration-300 hover:scale-105 border border-amber-400"
        onClick={() => navigate("/")}
      >
        Go Home
      </button>
